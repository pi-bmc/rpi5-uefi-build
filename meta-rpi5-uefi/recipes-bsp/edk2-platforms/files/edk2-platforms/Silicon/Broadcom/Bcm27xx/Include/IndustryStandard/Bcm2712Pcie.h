...
#define  AXI_EN_RCLK_QOS_ARRAY_FIX                 BIT13
#define  AXI_EN_QOS_UPDATE_TIMING_FIX              BIT12
#define  AXI_DIS_QOS_GATING_IN_MASTER              BIT11
#define  AXI_REQFIFO_EN_QOS_PROPAGATION            BIT7
#define  AXI_BRIDGE_LOW_LATENCY_MODE               BIT6
