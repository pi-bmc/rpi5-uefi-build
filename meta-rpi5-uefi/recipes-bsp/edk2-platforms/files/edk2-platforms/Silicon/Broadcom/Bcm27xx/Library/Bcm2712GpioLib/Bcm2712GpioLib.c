  ...
  )
{
  ...
  MmioAndThenOr32 (
    Controller->PinctrlBase + Regs->MuxReg,
  ...
  )
{
  ...
  GPIOLIB_ASSERT_OR_FAIL (
    Pull == BCM2712_GPIO_PIN_PULL_NONE
  ...
  MmioAndThenOr32 (
    Controller->PinctrlBase + Regs->CtlReg,
  ...
  )
{
  ...
  GPIOLIB_ASSERT_OR_FAIL (
    Direction != BCM2712_GPIO_PIN_OUTPUT
