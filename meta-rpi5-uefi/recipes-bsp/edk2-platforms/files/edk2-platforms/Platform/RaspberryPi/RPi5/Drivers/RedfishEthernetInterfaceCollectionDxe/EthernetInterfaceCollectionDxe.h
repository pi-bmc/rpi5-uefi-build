/** @file
  ...
  Redfish EthernetInterfaceCollection collection driver - header.
...
#include <RedfishJsonStructure/EthernetInterfaceCollection/EfiEthernetInterfaceCollection.h>
#include <RedfishCollectionCommon.h>

#define REDFISH_SCHEMA_NAME  "EthernetInterface"
#define REDFISH_MANAGED_URI  L"Systems/{}/EthernetInterfaces/{}"
